																			...
																			<div class="panel-body">
																				...
																				<div class="col-lg-12">
																					<div class="form-group">
																						...
																						<div class=" col-lg-4">
																							<label>Turma </label>
																							<select class="form-control m-b " name="class_id"></select>
																						</div>
																						<div class=" col-lg-4">
																							<label>Cidade </label>
																							<select class="form-control m-b " name="city_id"></select>
																						</div>
																					</div>
																					<div class="form-group">
																						<div class=" col-lg-6">
																							<label>Consultor </label>
																							<select class="form-control m-b " name="consultant"></select>
																						</div>
																						<div class="col-lg-3">
																							<div class="form-group col-lg-12 date">
																								...
																								<div class="input-group date">
																									...
																									<input type="text" id="start_payment_date" name="start_payment_date" class="form-control"  readonly>
																								</div>
																							</div>
																						</div>
																						<div class=" col-lg-3">
																							<label>Forma de Pagamento </label>
																							<select class="form-control m-b " name="form_payment">
																					...
																					<div class="form-group">
																						<div class="col-sm-4">
																							...
																							<input type="text" id="total_value" name="total_value" class="form-control" value="" >
																						</div>
																						<div class="col-sm-4">
																						...
																						<div class="col-sm-4">
																							...
																							<input type="text" id="total_payble" name="total_payble" class="form-control" value="" >
																						</div>
																					</div>
																					<div class="form-group">
																						<div class="col-sm-3">
																							<label class=" control-label">Qdt Parcelas</label>
																							<input type="text" id="number_installments" name="number_installments" class="form-control" value="" >
																						</div>
																						<div class="col-sm-3">
																							<label class=" control-label">Parcela SD</label>
																							<input type="text" id="installments_sd" name="installments_sd" class="form-control" value="" >
																						</div>
																						<div class="col-sm-3">
																							<label class=" control-label">Parcela CD</label>
																							<input type="text" id="installments_cd" name="installments_cd" class="form-control" value="" >
																						</div>
																						<div class="col-sm-3">
																							<label class=" control-label">Dia do Vencimento</label>
																							<input type="text" id="expiry_payment_day" name="expiry_payment_day" class="form-control" value="" >
																						</div>
																					</div>
																				</div>
