...
<section class="section section-lg bg-default novi-bg novi-bg-img">
	...
	<div class="container">
		<dl class="">
			<dt class="heading-6">{{ internation($items, 'title')}}</dt><br/>
			<dd>
				{!! internation($items, 'text') !!}
			</dd>
		</dl>
		<a class="privacy-link" href="mailto:atendimento@transformadoresminuzzi.com.br?subject=Informação sobre a Minuzzi" target="_blank">atendimento@transformadoresminuzzi.com.br</a>
	</div>
</section>
@endforeach
