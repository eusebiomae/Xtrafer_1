 ...
 <section class="breadcrumb-section blog">
 <div class="container">
 ...
 <div class="col-12 col-lg-6 col-md-6 item blog_item"
 data-key="blogCategory_{{ $blog->blogCategory->id }}">
 <div class="grid-news-wrapper">
 <div class="grid-news-item">
 <div class="grid-news-img"> <img src="{{ $blog->image }}" alt="img"
 style="height: auto;"> </div>
 <div class="grid-news-info">
 {{-- <h2>{{$blog->title_pt}}</h2> --}}
 <div class="grid-news-action-info">
 <div class="grid-news-action-list"> <span><i
 class="material-icons">category</i></span>
 ...
 <div class="grid-news-button"> <a href="blog_details/{{ $blog->id }}"
 class="news-read-more-btn">Ler mais...</a> </div>
 </div>
 </div>
 </div>
 @endforeach
 ...
 <button type="submit" class="search-widget-btn"><i
 ...
 <li><a href="#blog" type="button" class="category_item"
 data-key="{{ $item->id }}"
 onclick="btnBlog({{ $item->id }})">{{ $item->description_pt }}</a></li>
 @endforeach
 </ul>
 </div>
